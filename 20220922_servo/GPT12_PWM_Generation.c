...
#define PWM_DUTY_CYCLE              25                      /* Duty cycle of the PWM signal in percentage           */
#define PIN                         &MODULE_P02, 4          /* LED which toggles in the Interrupt Service Routine   */
...
void initGpt12PWM(void)
{
    ...
    /* Initialize the LED */
    IfxPort_setPinModeOutput(PIN, IfxPort_OutputMode_pushPull, IfxPort_OutputIdx_general);
}
...
void Set_GptPWM_Duty(float pmw_duty)
{
