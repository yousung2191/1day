...
#define PWM_DUTY_CYCLE              40                      /* Duty cycle of the PWM signal in percentage           */
...
#define TEST_PIN1                   &MODULE_P02, 0          /* LED which toggles in the Interrupt Service Routine   */
