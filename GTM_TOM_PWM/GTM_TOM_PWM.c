...
#define Test_PIN_1          IfxGtm_TOM0_8_TOUT0_P02_0_OUT
...
void initGtmTomPwm(void)
{
    ...
    g_tomConfig.tom = Test_PIN_1.tom;                                      /* Select the TOM depending on the LED          */
    g_tomConfig.tomChannel = Test_PIN_1.channel;
    g_tomConfig.period = PWM_PERIOD;                                /* Set the timer period                         */
    //g_tomConfig.pin.outputPin = &LED;
    g_tomConfig.pin.outputPin = &Test_PIN_1;                               /* Set the LED port pin as output               */
